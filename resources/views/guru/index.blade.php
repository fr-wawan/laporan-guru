...
<div class=" mt-32">
  ...
  <div class="w-11/12 mx-auto bg-white p-10 rounded-lg shadow-lg mb-10">

    <h1 class="font-bold mb-5 text-xl border-b pb-3">Upload PDF</h1>
    <form action="{{ route('upload.guru.store') }}" enctype="multipart/form-data" method="post">
  ...
  <div class="w-11/12 mx-auto bg-white p-10 rounded-lg shadow-lg">
    ...
    <h1 class="font-bold mb-5 text-xl border-b pb-3">Detail Guru {{ auth()->guard('guru')->user()->nama }}</h1>
    <form action="{{ route('admin.guru.update',$guru->id) }}" enctype="multipart/form-data" method="post">
      ...
      <div class="lg:flex gap-5">
        <div class="w-full ">
          <x-input name="tempat_lahir" label="Tempat Lahir Guru : " placeholder="Tempat Lahir Guru..."
            :value="old('tempat_lahir',$guru->tempat_lahir)" :disabled="true" />
        </div>

        <div class="w-full ">
          <x-input name="tanggal_lahir" label="Tanggal Lahir Guru : " placeholder="Tanggal Lahir Guru..."
            :value="old('tanggal_lahir',$guru->tanggal_lahir)" type="date" :disabled="true" />
        </div>
      </div>
      ...
      <div class="lg:flex  gap-5">
        ...
        <div class="w-full my-3">
          ...
          <select name="jenis_ptk" disabled id="jenis_ptk"
            class="block border border-gray-300 w-full p-2 rounded-lg mt-2 placeholder:text-sm">
      ...
      <div class=" w-full">
        <x-input name="alamat" label="Alamat Guru : " placeholder="Alamat Guru..." :value="old('alamat',$guru->alamat)"
          :disabled="true" />
      </div>
      ...
      <div class="my-3 w-full">
        ...
        <input id="x" type="hidden" name="tugas_tambahan" disabled
          value="{{ old('tugas_tambahan',$guru->tugas_tambahan) }}">
        <trix-editor input="x" id="tugas_tambahan_editor"> </trix-editor>
      ...
      <div class="my-3 w-full">
        ...
        <select name="surat_keputusan_id" id="sk" class="border" disabled>
          <option></option>
