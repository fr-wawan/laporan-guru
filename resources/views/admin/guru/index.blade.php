...
<div class="sm:ml-64 mt-32 ">
  ...
  <div class="w-11/12 mx-auto">
    ...
    <x-table :headers="['NIK','Nama','NPWP','NUPTK','Status','Jenis PTK','Jenis Kelamin']">
      ...
      <tr class="bg-white border-b hover:bg-gray-50 text-center">
        ...
        <td class="px-6 py-4">
          {{ formatNpwp($guru->npwp) }}
        </td>
        <td class="px-6 py-4">
          {{ $guru->nuptk }}
        </td>
        <td class="px-6 py-4">
          @if ($guru->status == 'guru_honor')
          Guru Honor
          @else
          Yayasan
          @endif
    ...
    @if ($listGuru->hasPages())
    <div class=" p-3">
      {{ $listGuru->links('vendor.pagination.tailwind') }}
    </div>
    @endif
